      ...
      <div className='ext-forum-home'>
            ...
            <div className='container'>
              ...
              { forum.extra.contentType === 'llamado' && 
                <a
                  className='btn btn-primary'
                  onClick={this.handleScroll} >
                   { !isClosed && 'Haz tu propuesta' || 'Conoce las propuestas' }
                </a>
              }
            </div>
          </div>
        ...
        <div className='container topics-container' >
          {this.state.topics.length > 0 && (forum.extra.contentType === 'ejes' || forum.extra.contentType === undefined) &&
            <h5 id='anchor'>{`${this.state.topics.length} ${this.state.topics.length > 1 ? 'ejes comprenden' : 'eje comprende'} este reto de ciudad`}</h5>
          }
